...
import { INIT_CODE_HASH, WETH } from 'constants/trade'
...
export const swapCallParameters = (
	...
	const deadline =
		'ttl' in options
			...
			: `0x${options.deadline.toString(16)}` // eslint-disable-line prettier/prettier

	const useFeeOnTransfer = Boolean(options.feeOnTransfer)

	let methodName = '' // eslint-disable-line prettier/prettier
